        ...
        <div class="col-lg-5 col-md-12 bg-white p-5 d-flex flex-column justify-content-center">
            ...
            <form class="form p-4" action="{{ route('login.auth') }}" method="POST">
                    ...
                    <div class="text-center">
                        <button type="submit" name="isCreatingAccount" value="false" class="btn btn w-100"
                            style="background-color: #133E87; color: white; font-weight: bold;">Login</button>
                    </div>
                </form>
            </div>

            <div class="col-lg-7 d-none d-lg-flex p-5 position-relative"
                style="background-color: #133E87 ; overflow: hidden;">
                <div
                    style="
                position: absolute;
                top: 0;
                ...
                <div class="d-flex flex-column justify-content-center align-items-center text-center"
                    ...
                    <p class="lh-lg" style=" max-width: 500px; font-size: 0.9rem; color: white;">
                        Aplikasi yang Mencatat dan menganalisis keterlambatan siswa. Yang bertujuan untuk memantau
                        kedisiplinan siswa, menemukan alasan/pola keterlambatan, dan membantu pencatatan keterlambatan.
                    </p>
                </div>
            </div>
        </div>
